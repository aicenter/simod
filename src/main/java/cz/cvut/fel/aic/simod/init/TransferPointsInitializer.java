...
public class TransferPointsInitializer {
    ...
    public List<SimulationNode> loadTransferPoints(){
        List<SimulationNode> transferPoints = new ArrayList<>();
        List<String[]> stationRows = loadTransferPointsRows(config.transferPointsFilepath);
...
//                }
    ...
    private List<String[]> loadTransferPointsRows(String filepath){
