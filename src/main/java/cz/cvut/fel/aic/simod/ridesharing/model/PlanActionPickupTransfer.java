...
public class PlanActionPickupTransfer extends PlanRequestAction {

    /**
     * PickupTransfer action.
     * @param request Request
     * @param node Position where action takes place.
     * @param maxTime Time constraint in seconds.
     */
    public PlanActionPickupTransfer(PlanComputationRequest request, SimulationNode node, int maxTime) {
