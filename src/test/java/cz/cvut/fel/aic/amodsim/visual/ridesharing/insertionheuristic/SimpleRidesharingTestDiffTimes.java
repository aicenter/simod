...
import cz.cvut.fel.aic.amodsim.visual.ridesharing.scenarios.SimpleRidesharingDiffTimesScenario;
...
public class SimpleRidesharingTestDiffTimes {
	...
	public void run() throws Throwable{
		new SimpleRidesharingDiffTimesScenario().run(new InsertionHeuristicTestEnvironment());
	}
