...
public class TNRTravelTimeProvider extends TravelTimeProvider{
    ...
    public TNRTravelTimeProvider(TimeProvider timeProvider, TripsUtil tripsUtil, TransportNetworks transportNetworks, AmodsimConfig config) {
        ...
        //System.loadLibrary("shortestPaths");
        //this.dqm = new TNRDistanceQueryManagerAPI();
        // FIXME relative path should be probably used here instead. Maybe this should be included in the config as well?
        //this.dqm.initializeTNR("/home/xenty/sum/2019/ContractionHierarchies/amod-to-agentpolis/data/shortestpathslib/Prague2000tnodes.tnrg", "/home/xenty/sum/2019/ContractionHierarchies/amod-to-agentpolis/data/shortestpathslib/PragueMapping.xeni");
    }
