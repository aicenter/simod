...
axis1.hist([delays_window_2, delays_window_3, delays_window_4, delays_window_5], bins,
		  label=common.labels[1:], histtype='step')
axis2.hist([delays_window_7, delays_window_8, delays_window_9, delays_window_10], bins,
		  label=common.labels[1:], histtype='step')
