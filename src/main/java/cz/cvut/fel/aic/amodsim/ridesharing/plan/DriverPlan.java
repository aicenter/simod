...
//		plan.set(0, new DriverPlanTask(OnDemandVehicleEvent.CURRENT_POSITION, null, position));
//	}
	...
	public void taskCompleted(){
		...
		if(removedTask.getTaskType() == OnDemandVehicleEvent.DROP_OFF && demands != null){
