...
from json_cache import load_json_file
...
def load_all_edges_load_history(filepath = config.agentpolis.statistics.all_edges_load_history_file_path):
...
class TrafficDensityLevel(Enum):
    ...
    # FREE = (0.05, "lightgrey")
    CONGESTED = (100, color_from_map(0.0))
