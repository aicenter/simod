...
# 		  normed=True)
axes.hist([delays_1, delays_2, delays_3], bins, label=['No Ridesharing', 'Insertion Heuristic', 'VGA'], normed=True)
axes.yaxis.set_major_formatter(FuncFormatter(to_percent))

fig, axes = plt.subplots(1, 1, subplot_kw={"adjustable": 'box'}, figsize=(4, 3))
axes.hist([delays_window_1, delays_window_2, delays_window_3], bins,
		  label=['No Ridesharing', 'Insertion Heuristic', 'VGA'], normed=True)
