...
public class OnDemandPFVehicle extends Agent implements EventHandler, PlanningAgent,
        Driver<PhysicalPFVehicle>
{
    ...
    public OnDemandPFVehicle(
            PhysicalPFVehicleStorage vehicleStorage,
            TripsUtil tripsUtil,
...
//	}
    ...
    @Override
    public void startDriving(PhysicalPFVehicle vehicle)
    {
