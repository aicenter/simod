...
public class Weight1Scenario {
	...
	public void run(RidesharingTestEnvironment testEnvironment) throws Throwable{
		...
		expectedEvents.add(new RidesharingEventData("1", 1, OnDemandVehicleEvent.DEMAND_PICKUP));
		expectedEvents.add(new RidesharingEventData("0", 0, OnDemandVehicleEvent.DEMAND_DROP_OFF));
		expectedEvents.add(new RidesharingEventData("1", 1, OnDemandVehicleEvent.DEMAND_DROP_OFF));
