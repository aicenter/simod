 ...
 * @author matal
 */
public class TestGeojsonMapInitializerAstar extends MapInitializer{
	...
	@Inject
	public TestGeojsonMapInitializerAstar(Transformer projection, AgentpolisConfig config) {
		super(config);
